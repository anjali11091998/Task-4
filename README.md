...
DEMONSTRATE HOW TO BACK UP ADATABASE AND RESTORE IT IN CASE OF FAILURE. 

We explain how the database create and backup and after that how we can recover the database.
